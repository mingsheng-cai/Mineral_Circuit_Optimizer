\chapter{Detailed Design Document for \texorpdfstring{$<$}{<}tt\texorpdfstring{$>$}{>}CSimulator\texorpdfstring{$<$}{<}/tt\texorpdfstring{$>$}{>} and Related Components}
\hypertarget{md_docs_2circuit__simulator}{}\label{md_docs_2circuit__simulator}\index{Detailed Design Document for $<$tt$>$CSimulator$<$/tt$>$ and Related Components@{Detailed Design Document for $<$tt$>$CSimulator$<$/tt$>$ and Related Components}}
\label{md_docs_2circuit__simulator_autotoc_md0}%
\Hypertarget{md_docs_2circuit__simulator_autotoc_md0}%
 \hypertarget{md_docs_2circuit__simulator_autotoc_md1}{}\doxysection{\texorpdfstring{Introduction}{Introduction}}\label{md_docs_2circuit__simulator_autotoc_md1}
This document provides a comprehensive design framework for the {\ttfamily CSimulator} class and its associated components. The {\ttfamily CSimulator} class is designed to simulate the mass balance of a separation circuit composed of multiple units, evaluate the performance of the circuit, and ensure that the circuit operates correctly under specified constraints.\hypertarget{md_docs_2circuit__simulator_autotoc_md2}{}\doxysection{\texorpdfstring{1. Overview of {\ttfamily CSimulator}}{1. Overview of {\ttfamily CSimulator}}}\label{md_docs_2circuit__simulator_autotoc_md2}
\hypertarget{md_docs_2circuit__simulator_autotoc_md3}{}\doxysubsection{\texorpdfstring{1.\+1 Purpose}{1.\+1 Purpose}}\label{md_docs_2circuit__simulator_autotoc_md3}
The purpose of the {\ttfamily CSimulator} class is to simulate the mass balance of a circuit that separates valuable material (gerardium) from waste. It calculates the mass flows through each unit in the circuit and determines the overall performance of the circuit.\hypertarget{md_docs_2circuit__simulator_autotoc_md4}{}\doxysubsection{\texorpdfstring{1.\+2 Scope}{1.\+2 Scope}}\label{md_docs_2circuit__simulator_autotoc_md4}
...
\end{DoxyItemize}\hypertarget{md_docs_2circuit__simulator_autotoc_md5}{}\doxysection{\texorpdfstring{2. Class Design}{2. Class Design}}\label{md_docs_2circuit__simulator_autotoc_md5}
\hypertarget{md_docs_2circuit__simulator_autotoc_md6}{}\doxysubsection{\texorpdfstring{2.\+1 UML Class Diagram}{2.\+1 UML Class Diagram}}\label{md_docs_2circuit__simulator_autotoc_md6}
...
\end{DoxyCode}
\hypertarget{md_docs_2circuit__simulator_autotoc_md7}{}\doxysubsection{\texorpdfstring{2.\+2 {\ttfamily CSimulator} Class}{2.\+2 {\ttfamily CSimulator} Class}}\label{md_docs_2circuit__simulator_autotoc_md7}
\hypertarget{md_docs_2circuit__simulator_autotoc_md8}{}\doxysubsubsection{\texorpdfstring{2.\+2.\+1 Attributes}{2.\+2.\+1 Attributes}}\label{md_docs_2circuit__simulator_autotoc_md8}
...
\end{DoxyItemize}\hypertarget{md_docs_2circuit__simulator_autotoc_md9}{}\doxysubsubsection{\texorpdfstring{2.\+2.\+2 Methods}{2.\+2.\+2 Methods}}\label{md_docs_2circuit__simulator_autotoc_md9}
...
{\bfseries{Parse\+Circuit\+Vector\+:}} This method parses the circuit vector into a structured representation by creating {\ttfamily \doxylink{class_c_unit}{CUnit}} objects for each unit in the circuit. It sets the connections between units based on the vector.\hypertarget{md_docs_2circuit__simulator_autotoc_md10}{}\doxysubsection{\texorpdfstring{2.\+3 {\ttfamily CUnit} Class}{2.\+3 {\ttfamily CUnit} Class}}\label{md_docs_2circuit__simulator_autotoc_md10}
\hypertarget{md_docs_2circuit__simulator_autotoc_md11}{}\doxysubsection{\texorpdfstring{2.\+3.\+1 Attributes}{2.\+3.\+1 Attributes}}\label{md_docs_2circuit__simulator_autotoc_md11}
...
\end{DoxyItemize}\hypertarget{md_docs_2circuit__simulator_autotoc_md12}{}\doxysubsection{\texorpdfstring{2.\+3.\+2 Methods}{2.\+3.\+2 Methods}}\label{md_docs_2circuit__simulator_autotoc_md12}
...
{\bfseries{Calculate\+Flows\+:}} This method calculates the mass flows for the unit based on the feed rate and given rate constants for the high-\/grade and intermediate streams. It computes the residence time and uses it to determine the flow rates for the concentrate, intermediate, and tailings streams.\hypertarget{md_docs_2circuit__simulator_autotoc_md13}{}\doxysection{\texorpdfstring{3. Function Definitions}{3. Function Definitions}}\label{md_docs_2circuit__simulator_autotoc_md13}
\hypertarget{md_docs_2circuit__simulator_autotoc_md14}{}\doxysubsection{\texorpdfstring{3.\+1 {\ttfamily CSimulator} Methods}{3.\+1 {\ttfamily CSimulator} Methods}}\label{md_docs_2circuit__simulator_autotoc_md14}
...
\end{DoxyItemize}\hypertarget{md_docs_2circuit__simulator_autotoc_md15}{}\doxysubsection{\texorpdfstring{3.\+2 {\ttfamily CUnit} Methods}{3.\+2 {\ttfamily CUnit} Methods}}\label{md_docs_2circuit__simulator_autotoc_md15}
{\bfseries{Constructor\+:}}
\begin{DoxyItemize}
...
\end{DoxyItemize}\hypertarget{md_docs_2circuit__simulator_autotoc_md16}{}\doxysection{\texorpdfstring{4. Validation and Testing}{4. Validation and Testing}}\label{md_docs_2circuit__simulator_autotoc_md16}
\hypertarget{md_docs_2circuit__simulator_autotoc_md17}{}\doxysubsection{\texorpdfstring{4.\+1 Unit Tests}{4.\+1 Unit Tests}}\label{md_docs_2circuit__simulator_autotoc_md17}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_docs_2circuit__simulator_autotoc_md18}{}\doxysubsection{\texorpdfstring{4.\+2 Integration Tests}{4.\+2 Integration Tests}}\label{md_docs_2circuit__simulator_autotoc_md18}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_docs_2circuit__simulator_autotoc_md19}{}\doxysection{\texorpdfstring{5. Performance Considerations}{5. Performance Considerations}}\label{md_docs_2circuit__simulator_autotoc_md19}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_docs_2circuit__simulator_autotoc_md20}{}\doxysection{\texorpdfstring{6. Documentation and Usage}{6. Documentation and Usage}}\label{md_docs_2circuit__simulator_autotoc_md20}
...
\item Example\+: 
\begin{DoxyCode}{0}
\DoxyCodeLine{\#\#\#\ User\ Guide}
\DoxyCodeLine{}
\DoxyCodeLine{\#\#\#\#\ Setup}
\DoxyCodeLine{1.\ Clone\ the\ repository.}
\DoxyCodeLine{2.\ Navigate\ to\ the\ project\ directory.}
\DoxyCodeLine{3.\ Install\ required\ dependencies:}

\end{DoxyCode}
 bash sudo apt-\/get install g++ sudo apt-\/get install cmake 
\begin{DoxyCode}{0}
\DoxyCodeLine{4.\ Build\ the\ project:}

\end{DoxyCode}
 bash mkdir build cd build cmake .. make 
\begin{DoxyCode}{0}
\DoxyCodeLine{\#\#\#\#\ Running\ the\ Simulator}
\DoxyCodeLine{To\ run\ the\ simulator,\ use\ the\ following\ command:}

\end{DoxyCode}
 bash ./simulator $<$input\+\_\+file$>$ 
\begin{DoxyCode}{0}
\DoxyCodeLine{Replace\ \`{}<input\_file>`\ with\ the\ path\ to\ your\ input\ configuration\ file.}
\DoxyCodeLine{}
\DoxyCodeLine{\#\#\#\#\ Example}

\end{DoxyCode}
 bash ./simulator config.\+txt 
\begin{DoxyCode}{0}
\DoxyCodeLine{\ \ \ \ \#\#\#\#\ Interpreting\ the\ Output}
\DoxyCodeLine{\ \ \ \ The\ simulator\ will\ output\ the\ performance\ score\ and\ the\ detailed\ mass\ flow\ rates\ for\ each\ unit\ in\ the\ circuit.}
\DoxyCodeLine{\ \ \ \ }
\DoxyCodeLine{}
\DoxyCodeLine{-\/\ **Code\ Comments:**\ }
\DoxyCodeLine{\ \ -\/\ Ensure\ all\ methods\ and\ key\ sections\ of\ the\ code\ are\ well-\/documented\ with\ comments\ explaining\ their\ functionality,\ parameters,\ and\ return\ values.}
\DoxyCodeLine{\ \ -\/\ Example:}
\DoxyCodeLine{\ \ \ \ @icode\{cpp\}\ }
\DoxyCodeLine{\ \ \ \ //\ Constructor\ for\ CSimulator}
\DoxyCodeLine{\ \ \ \ //\ Initializes\ the\ simulator\ with\ the\ given\ circuit\ vector,\ feed\ rate,\ tolerance,\ and\ max\ iterations.}
\DoxyCodeLine{\ \ \ \ CSimulator::CSimulator(std::vector<int>\&\ circuit\_vector,\ double\ feed\_rate,\ double\ tolerance,\ int\ max\_iterations)\ \{}
\DoxyCodeLine{\ \ \ \ \ \ \ \ //\ Initialization\ code}
\DoxyCodeLine{\ \ \ \ \}}
...
\#\#\# Example \doxylink{class_circuit}{Circuit} Vector
...
\#\#\# Expected Output  Performance Score\+: 110.\+25 Unit 0\+: Concentrate Rate\+: 1.\+5, Intermediate Rate\+: 0.\+3, Tailings Rate\+: 8.\+2 ... \`{}\`{}\`{}
\end{DoxyItemize}
\end{DoxyItemize}
