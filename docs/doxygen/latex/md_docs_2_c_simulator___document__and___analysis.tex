...
\hypertarget{md_docs_2_c_simulator___document__and___analysis}{}\label{md_docs_2_c_simulator___document__and___analysis}\index{Document \& Analysis for Circuit Simulator@{Document \& Analysis for Circuit Simulator}}
\label{md_docs_2_c_simulator___document__and___analysis_autotoc_md8}%
\Hypertarget{md_docs_2_c_simulator___document__and___analysis_autotoc_md8}%
 \hypertarget{md_docs_2_c_simulator___document__and___analysis_autotoc_md9}{}\doxysection{\texorpdfstring{Introduction}{Introduction}}\label{md_docs_2_c_simulator___document__and___analysis_autotoc_md9}
This document provides a comprehensive design framework for the {\ttfamily CSimulator} class and its associated components. The {\ttfamily CSimulator} class is designed to simulate the mass balance of a separation circuit composed of multiple units, evaluate the performance of the circuit, and ensure that the circuit operates correctly under specified constraints.\hypertarget{md_docs_2_c_simulator___document__and___analysis_autotoc_md10}{}\doxysection{\texorpdfstring{1. Overview of {\ttfamily CSimulator}}{1. Overview of {\ttfamily CSimulator}}}\label{md_docs_2_c_simulator___document__and___analysis_autotoc_md10}
\hypertarget{md_docs_2_c_simulator___document__and___analysis_autotoc_md11}{}\doxysubsection{\texorpdfstring{1.\+1 Purpose}{1.\+1 Purpose}}\label{md_docs_2_c_simulator___document__and___analysis_autotoc_md11}
The purpose of the {\ttfamily CSimulator} class is to simulate the mass balance of a circuit that separates valuable material (gerardium) from waste. It calculates the mass flows through each unit in the circuit and determines the overall performance of the circuit.\hypertarget{md_docs_2_c_simulator___document__and___analysis_autotoc_md12}{}\doxysubsection{\texorpdfstring{1.\+2 Scope}{1.\+2 Scope}}\label{md_docs_2_c_simulator___document__and___analysis_autotoc_md12}
...
\end{DoxyItemize}\hypertarget{md_docs_2_c_simulator___document__and___analysis_autotoc_md13}{}\doxysection{\texorpdfstring{2. Class Design}{2. Class Design}}\label{md_docs_2_c_simulator___document__and___analysis_autotoc_md13}
\hypertarget{md_docs_2_c_simulator___document__and___analysis_autotoc_md14}{}\doxysubsection{\texorpdfstring{2.\+1 UML Class Diagram}{2.\+1 UML Class Diagram}}\label{md_docs_2_c_simulator___document__and___analysis_autotoc_md14}
...
\end{DoxyCode}
\hypertarget{md_docs_2_c_simulator___document__and___analysis_autotoc_md15}{}\doxysubsection{\texorpdfstring{2.\+2 {\ttfamily CSimulator} Class}{2.\+2 {\ttfamily CSimulator} Class}}\label{md_docs_2_c_simulator___document__and___analysis_autotoc_md15}
\hypertarget{md_docs_2_c_simulator___document__and___analysis_autotoc_md16}{}\doxysubsubsection{\texorpdfstring{2.\+2.\+1 Attributes}{2.\+2.\+1 Attributes}}\label{md_docs_2_c_simulator___document__and___analysis_autotoc_md16}
...
\end{DoxyItemize}\hypertarget{md_docs_2_c_simulator___document__and___analysis_autotoc_md17}{}\doxysubsubsection{\texorpdfstring{2.\+2.\+2 Methods}{2.\+2.\+2 Methods}}\label{md_docs_2_c_simulator___document__and___analysis_autotoc_md17}
...
{\bfseries{Parse\+Circuit\+Vector\+:}} This method parses the circuit vector into a structured representation by creating {\ttfamily \doxylink{class_c_unit}{CUnit}} objects for each unit in the circuit. It sets the connections between units based on the vector.\hypertarget{md_docs_2_c_simulator___document__and___analysis_autotoc_md18}{}\doxysubsection{\texorpdfstring{2.\+3 {\ttfamily CUnit} Class}{2.\+3 {\ttfamily CUnit} Class}}\label{md_docs_2_c_simulator___document__and___analysis_autotoc_md18}
\hypertarget{md_docs_2_c_simulator___document__and___analysis_autotoc_md19}{}\doxysubsection{\texorpdfstring{2.\+3.\+1 Attributes}{2.\+3.\+1 Attributes}}\label{md_docs_2_c_simulator___document__and___analysis_autotoc_md19}
...
\end{DoxyItemize}\hypertarget{md_docs_2_c_simulator___document__and___analysis_autotoc_md20}{}\doxysubsection{\texorpdfstring{2.\+3.\+2 Methods}{2.\+3.\+2 Methods}}\label{md_docs_2_c_simulator___document__and___analysis_autotoc_md20}
...
{\bfseries{Calculate\+Flows\+:}} This method calculates the mass flows for the unit based on the feed rate and given rate constants for the high-\/grade and intermediate streams. It computes the residence time and uses it to determine the flow rates for the concentrate, intermediate, and tailings streams.\hypertarget{md_docs_2_c_simulator___document__and___analysis_autotoc_md21}{}\doxysection{\texorpdfstring{3. Function Definitions}{3. Function Definitions}}\label{md_docs_2_c_simulator___document__and___analysis_autotoc_md21}
\hypertarget{md_docs_2_c_simulator___document__and___analysis_autotoc_md22}{}\doxysubsection{\texorpdfstring{3.\+1 {\ttfamily CSimulator} Methods}{3.\+1 {\ttfamily CSimulator} Methods}}\label{md_docs_2_c_simulator___document__and___analysis_autotoc_md22}
...
\end{DoxyItemize}\hypertarget{md_docs_2_c_simulator___document__and___analysis_autotoc_md23}{}\doxysubsection{\texorpdfstring{3.\+2 {\ttfamily CUnit} Methods}{3.\+2 {\ttfamily CUnit} Methods}}\label{md_docs_2_c_simulator___document__and___analysis_autotoc_md23}
{\bfseries{Constructor\+:}}
\begin{DoxyItemize}
...
\end{DoxyItemize}\hypertarget{md_docs_2_c_simulator___document__and___analysis_autotoc_md24}{}\doxysection{\texorpdfstring{4. Validation and Testing}{4. Validation and Testing}}\label{md_docs_2_c_simulator___document__and___analysis_autotoc_md24}
\hypertarget{md_docs_2_c_simulator___document__and___analysis_autotoc_md25}{}\doxysubsection{\texorpdfstring{4.\+1 Unit Tests}{4.\+1 Unit Tests}}\label{md_docs_2_c_simulator___document__and___analysis_autotoc_md25}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_docs_2_c_simulator___document__and___analysis_autotoc_md26}{}\doxysubsection{\texorpdfstring{4.\+2 Integration Tests}{4.\+2 Integration Tests}}\label{md_docs_2_c_simulator___document__and___analysis_autotoc_md26}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_docs_2_c_simulator___document__and___analysis_autotoc_md27}{}\doxysection{\texorpdfstring{5. Performance Considerations}{5. Performance Considerations}}\label{md_docs_2_c_simulator___document__and___analysis_autotoc_md27}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_docs_2_c_simulator___document__and___analysis_autotoc_md28}{}\doxysection{\texorpdfstring{6. Usage}{6. Usage}}\label{md_docs_2_c_simulator___document__and___analysis_autotoc_md28}
...
\item Example\+:
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_docs_2_c_simulator___document__and___analysis_autotoc_md29}{}\doxysubsubsection{\texorpdfstring{Setup}{Setup}}\label{md_docs_2_c_simulator___document__and___analysis_autotoc_md29}
...
{\ttfamily shell sudo apt-\/get install g++ sudo apt-\/get install cmake } \hypertarget{md_docs_2_c_simulator___document__and___analysis_autotoc_md30}{}\doxysubsubsection{\texorpdfstring{Build the project}{Build the project}}\label{md_docs_2_c_simulator___document__and___analysis_autotoc_md30}
{\ttfamily shell mkdir build cd build cmake .. make }\hypertarget{md_docs_2_c_simulator___document__and___analysis_autotoc_md31}{}\doxysubsubsection{\texorpdfstring{Running the Simulator}{Running the Simulator}}\label{md_docs_2_c_simulator___document__and___analysis_autotoc_md31}
To run the simulator, use the following command\+: {\ttfamily shell ./simulator \texorpdfstring{$<$}{<}input\+\_\+file\texorpdfstring{$>$}{>} } Replace {\ttfamily \texorpdfstring{$<$}{<}input\+\_\+file\texorpdfstring{$>$}{>}} with the path to your input configuration file.\hypertarget{md_docs_2_c_simulator___document__and___analysis_autotoc_md32}{}\doxysubsubsection{\texorpdfstring{Example}{Example}}\label{md_docs_2_c_simulator___document__and___analysis_autotoc_md32}
{\ttfamily shell ./simulator config.\+txt }\hypertarget{md_docs_2_c_simulator___document__and___analysis_autotoc_md33}{}\doxysubsubsection{\texorpdfstring{Interpreting the Output}{Interpreting the Output}}\label{md_docs_2_c_simulator___document__and___analysis_autotoc_md33}
...
\item Example\+:
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_docs_2_c_simulator___document__and___analysis_autotoc_md34}{}\doxysubsection{\texorpdfstring{Example Circuit Vector}{Example Circuit Vector}}\label{md_docs_2_c_simulator___document__and___analysis_autotoc_md34}

\begin{DoxyCode}{0}
\DoxyCodeLine{0,\ 1,\ 3,\ 3,\ 2,\ 2,\ 0,\ 4,\ 1,\ 1,\ 1,\ 0,\ 5}

\end{DoxyCode}
\hypertarget{md_docs_2_c_simulator___document__and___analysis_autotoc_md35}{}\doxysubsection{\texorpdfstring{Expected Output}{Expected Output}}\label{md_docs_2_c_simulator___document__and___analysis_autotoc_md35}
