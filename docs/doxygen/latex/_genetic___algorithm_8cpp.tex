\doxysection{src/\+Genetic\+\_\+\+Algorithm.cpp File Reference}
\hypertarget{_genetic___algorithm_8cpp}{}\label{_genetic___algorithm_8cpp}\index{src/Genetic\_Algorithm.cpp@{src/Genetic\_Algorithm.cpp}}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{_genetic___algorithm_8cpp__incl}
\end{center}
\end{figure}
\doxysubsubsection*{Macros}
\begin{DoxyCompactItemize}
\item 
\#define \mbox{\hyperlink{_genetic___algorithm_8cpp_ae28bf2b9191de07c5bd587e0e8186405}{INVALID\+\_\+\+FITNESS}}~-\/1000000000.\+0
\end{DoxyCompactItemize}
\doxysubsubsection*{Functions}
\begin{DoxyCompactItemize}
\item 
void \mbox{\hyperlink{_genetic___algorithm_8cpp_a5758e13cc14bb5f332da692d118ca98a}{initialize\+Random\+Seed}} (const \mbox{\hyperlink{struct_algorithm___parameters}{Algorithm\+\_\+\+Parameters}} \&params, std\+::vector$<$ std\+::mt19937 $>$ \&generators)
\begin{DoxyCompactList}\small\item\em Initializes the random seed based on algorithm parameters. \end{DoxyCompactList}\item 
std\+::vector$<$ \mbox{\hyperlink{struct_individual}{Individual}} $>$ \mbox{\hyperlink{_genetic___algorithm_8cpp_aed0dc0d7a485d04965c9810ca2217222}{initialize\+Population}} (const \mbox{\hyperlink{struct_algorithm___parameters}{Algorithm\+\_\+\+Parameters}} \&params, int vector\+Size, bool(\&validity)(int, int \texorpdfstring{$\ast$}{*}), std\+::vector$<$ std\+::mt19937 $>$ \&generators)
\begin{DoxyCompactList}\small\item\em Initializes the population for the genetic algorithm. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{_genetic___algorithm_8cpp_a67d1d9548b0f13a3e42eb769e4a3da02}{elitism}} (const std\+::vector$<$ \mbox{\hyperlink{struct_individual}{Individual}} $>$ \&population, std\+::vector$<$ \mbox{\hyperlink{struct_individual}{Individual}} $>$ \&new\+Population, const \mbox{\hyperlink{struct_algorithm___parameters}{Algorithm\+\_\+\+Parameters}} \&params)
...
double \mbox{\hyperlink{_genetic___algorithm_8cpp_ae1ecff79583da4244ddf97b989270a61}{acceptance\+Probability}} (double current\+Energy, double new\+Energy, double temperature)
...
int \mbox{\hyperlink{_genetic___algorithm_8cpp_a4eb04506c5788c119795cd6e3e0c6479}{optimize}} (int vector\+\_\+size, int \texorpdfstring{$\ast$}{*}vector, double(\&func)(int, int \texorpdfstring{$\ast$}{*}, struct \mbox{\hyperlink{struct_circuit_parameters}{Circuit\+Parameters}}), bool(\&validity)(int, int \texorpdfstring{$\ast$}{*}), \mbox{\hyperlink{struct_algorithm___parameters}{Algorithm\+\_\+\+Parameters}} params, \mbox{\hyperlink{struct_circuit_parameters}{Circuit\+Parameters}} c\+\_\+params)
...
\Hypertarget{_genetic___algorithm_8cpp_ae28bf2b9191de07c5bd587e0e8186405}\label{_genetic___algorithm_8cpp_ae28bf2b9191de07c5bd587e0e8186405} 
\index{Genetic\_Algorithm.cpp@{Genetic\_Algorithm.cpp}!INVALID\_FITNESS@{INVALID\_FITNESS}}
\index{INVALID\_FITNESS@{INVALID\_FITNESS}!Genetic\_Algorithm.cpp@{Genetic\_Algorithm.cpp}}
\doxysubsubsection{\texorpdfstring{INVALID\_FITNESS}{INVALID\_FITNESS}}
{\footnotesize\ttfamily \#define INVALID\+\_\+\+FITNESS~-\/1000000000.\+0}



\doxysubsection{Function Documentation}
\Hypertarget{_genetic___algorithm_8cpp_ae1ecff79583da4244ddf97b989270a61}\label{_genetic___algorithm_8cpp_ae1ecff79583da4244ddf97b989270a61} 
\index{Genetic\_Algorithm.cpp@{Genetic\_Algorithm.cpp}!acceptanceProbability@{acceptanceProbability}}
\index{acceptanceProbability@{acceptanceProbability}!Genetic\_Algorithm.cpp@{Genetic\_Algorithm.cpp}}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{_genetic___algorithm_8cpp_ae1ecff79583da4244ddf97b989270a61_icgraph}
\end{center}
\end{figure}
\Hypertarget{_genetic___algorithm_8cpp_a51da111672cefadb49ebda7a804df121}\label{_genetic___algorithm_8cpp_a51da111672cefadb49ebda7a804df121} 
\index{Genetic\_Algorithm.cpp@{Genetic\_Algorithm.cpp}!applySimulatedAnnealing@{applySimulatedAnnealing}}
\index{applySimulatedAnnealing@{applySimulatedAnnealing}!Genetic\_Algorithm.cpp@{Genetic\_Algorithm.cpp}}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{_genetic___algorithm_8cpp_a51da111672cefadb49ebda7a804df121_cgraph}
\end{center}
\end{figure}
Here is the caller graph for this function\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=350pt]{_genetic___algorithm_8cpp_a51da111672cefadb49ebda7a804df121_icgraph}
\end{center}
\end{figure}
\Hypertarget{_genetic___algorithm_8cpp_a67d1d9548b0f13a3e42eb769e4a3da02}\label{_genetic___algorithm_8cpp_a67d1d9548b0f13a3e42eb769e4a3da02} 
\index{Genetic\_Algorithm.cpp@{Genetic\_Algorithm.cpp}!elitism@{elitism}}
\index{elitism@{elitism}!Genetic\_Algorithm.cpp@{Genetic\_Algorithm.cpp}}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{_genetic___algorithm_8cpp_a67d1d9548b0f13a3e42eb769e4a3da02_icgraph}
\end{center}
\end{figure}
\Hypertarget{_genetic___algorithm_8cpp_aed0dc0d7a485d04965c9810ca2217222}\label{_genetic___algorithm_8cpp_aed0dc0d7a485d04965c9810ca2217222} 
\index{Genetic\_Algorithm.cpp@{Genetic\_Algorithm.cpp}!initializePopulation@{initializePopulation}}
\index{initializePopulation@{initializePopulation}!Genetic\_Algorithm.cpp@{Genetic\_Algorithm.cpp}}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{_genetic___algorithm_8cpp_aed0dc0d7a485d04965c9810ca2217222_icgraph}
\end{center}
\end{figure}
\Hypertarget{_genetic___algorithm_8cpp_a5758e13cc14bb5f332da692d118ca98a}\label{_genetic___algorithm_8cpp_a5758e13cc14bb5f332da692d118ca98a} 
\index{Genetic\_Algorithm.cpp@{Genetic\_Algorithm.cpp}!initializeRandomSeed@{initializeRandomSeed}}
\index{initializeRandomSeed@{initializeRandomSeed}!Genetic\_Algorithm.cpp@{Genetic\_Algorithm.cpp}}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{_genetic___algorithm_8cpp_a5758e13cc14bb5f332da692d118ca98a_icgraph}
\end{center}
\end{figure}
\Hypertarget{_genetic___algorithm_8cpp_a4eb04506c5788c119795cd6e3e0c6479}\label{_genetic___algorithm_8cpp_a4eb04506c5788c119795cd6e3e0c6479} 
\index{Genetic\_Algorithm.cpp@{Genetic\_Algorithm.cpp}!optimize@{optimize}}
\index{optimize@{optimize}!Genetic\_Algorithm.cpp@{Genetic\_Algorithm.cpp}}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{_genetic___algorithm_8cpp_a4eb04506c5788c119795cd6e3e0c6479_cgraph}
\end{center}
\end{figure}
Here is the caller graph for this function\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=350pt]{_genetic___algorithm_8cpp_a4eb04506c5788c119795cd6e3e0c6479_icgraph}
\end{center}
\end{figure}
